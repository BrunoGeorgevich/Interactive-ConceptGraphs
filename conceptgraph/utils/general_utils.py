...
def annotate_for_vlm(
    ...
    for i in sorted_indices:
        try:
            ...
            print(f"Index {i} out of range for detections or labels.")
            continue
    ...
    for idx in sorted_indices:
        try:
            ...
            label_num = labels[idx].split(" ")[
                -1
            ]  # Assuming label format is 'object X'
            ...
            print(f"Index {idx} out of range for detections or labels.")
            continue
...
def filter_detections(
    ...
    if len(filtered_detections) == 0:
        print("No detections passed the filtering criteria.")
        return detections, []
...
def save_pointcloud(
    ...
    if create_symlink and latest_pcd_filepath:
        ...
        try:
            ...
            print("Failed to create symlink. On windows this feature do not work.")
        print(
